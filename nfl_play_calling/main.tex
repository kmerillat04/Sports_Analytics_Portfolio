...
\usepackage{longtable}  % Better tables if needed
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/pass_advantage_chart.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/pass_advantage_flip.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/play_calling_efficiency.png}
