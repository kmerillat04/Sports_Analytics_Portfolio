...
The optimization model was implemented in Python using pandas and PuLP. The full script used to load the data, define the binary decision variables, apply the lineup constraints, and solve the model is included in the repository as \texttt{analysis.py}.

\begin{verbatim}
import pandas as pd
import pulp

# Load data, define decision variables, add constraints, solve model
\end{verbatim}
